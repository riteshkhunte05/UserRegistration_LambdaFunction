...
public class UserValidation {
    public static boolean firstNameValidation(String firstName) throws UserValidException {
        try {
            ...
            throw new UserValidException("Invalid input");
        }
    }

    public static boolean lastNameValidation(String lastName) throws UserValidException {
        try {
    ...
    public static boolean emailValidation(String email) throws UserValidException {
        try {
    ...
    public static boolean phoneNumberValidation(String phoneNumber) throws UserValidException {
        try {
    ...
    public static boolean passwordValidation(String password) throws UserValidException {
        try {
